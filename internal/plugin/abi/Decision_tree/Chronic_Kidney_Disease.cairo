...
fn main() -> u32 {
    ...
    let nodes_featureids: Span<usize> = array![11, 15, 0, 0, 0].span();
    ...
    let nodes_values: Span<FP16x16> = array![FP16x16 { mag: 3763, sign: false }, FP16x16 { mag: 37137, sign: false }, FP16x16 { mag: 0, sign: false }, FP16x16 { mag: 0, sign: false }, FP16x16 { mag: 0, sign: false }].span();
